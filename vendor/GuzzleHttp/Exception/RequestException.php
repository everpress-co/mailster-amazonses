...
use Mailster\Aws3\GuzzleHttp\BodySummarizer;
use Mailster\Aws3\GuzzleHttp\BodySummarizerInterface;
use Mailster\Aws3\Psr\Http\Client\RequestExceptionInterface;
