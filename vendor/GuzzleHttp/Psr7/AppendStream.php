 ...
 */
class AppendStream implements \Mailster\Aws3\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\Mailster\Aws3\Psr\Http\Message\StreamInterface $stream)
    {
