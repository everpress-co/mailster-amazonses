 ...
 */
class FnStream implements \Mailster\Aws3\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\Mailster\Aws3\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
