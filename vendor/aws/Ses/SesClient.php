...
namespace Mailster\Aws3\Aws\Ses;
 ...
 */
class SesClient extends \Mailster\Aws3\Aws\AwsClient
{
    /**
     ...
     * @return string
     */
    public static function generateSmtpPassword(\Mailster\Aws3\Aws\Credentials\CredentialsInterface $creds)
    {
        static $version = "\2";
        static $algo = 'sha256';
