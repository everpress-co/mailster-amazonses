 ...
 */
class Operation extends \Mailster\Aws3\Aws\Api\AbstractModel
{
    private $input;
    private $output;
    private $errors;
    ...
    public function getInput()
    {
        if (!$this->input) {
            if ($input = $this['input']) {
                ...
                $this->input = new \Mailster\Aws3\Aws\Api\StructureShape([], $this->shapeMap);
            }
        }
        return $this->input;
    }
    ...
    public function getOutput()
    {
        if (!$this->output) {
            if ($output = $this['output']) {
                ...
                $this->output = new \Mailster\Aws3\Aws\Api\StructureShape([], $this->shapeMap);
            }
        }
        return $this->output;
    }
