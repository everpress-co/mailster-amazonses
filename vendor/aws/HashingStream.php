 ...
 */
class HashingStream implements \Mailster\Aws3\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function __construct(\Mailster\Aws3\Psr\Http\Message\StreamInterface $stream, \Mailster\Aws3\Aws\HashInterface $hash, callable $onComplete = null)
    {
        $this->stream = $stream;
        $this->hash = $hash;
