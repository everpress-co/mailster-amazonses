 ...
 */
class AesEncryptingStream implements \Mailster\Aws3\Aws\Crypto\AesStreamInterface
{
    const BLOCK_SIZE = 16;
    // 128 bits
     ...
     */
    public function __construct(\Mailster\Aws3\Psr\Http\Message\StreamInterface $plainText, $key, \Mailster\Aws3\Aws\Crypto\Cipher\CipherMethod $cipherMethod)
    {
