...
use Mailster\Aws3\Aws\Crypto\Cipher\CipherMethod;
/**
 * @internal Represents a stream of data to be decrypted with passed cipher.
 */
class AesDecryptingStream implements \Mailster\Aws3\Aws\Crypto\AesStreamInterface
{
    const BLOCK_SIZE = 16;
    // 128 bits
     ...
     */
    public function __construct(\Mailster\Aws3\Psr\Http\Message\StreamInterface $cipherText, $key, \Mailster\Aws3\Aws\Crypto\Cipher\CipherMethod $cipherMethod)
    {
