...
use Mailster\Aws3\Aws\CommandPool;
use Mailster\Aws3\Aws\Exception\AwsException;
use Mailster\Aws3\Aws\Exception\MultipartUploadException;
...
abstract class AbstractUploadManager implements \Mailster\Aws3\GuzzleHttp\Promise\PromisorInterface
{
    ...
    private static $defaultConfig = ['part_size' => null, 'state' => null, 'concurrency' => self::DEFAULT_CONCURRENCY, 'prepare_data_source' => null, 'before_initiate' => null, 'before_upload' => null, 'before_complete' => null, 'exception_class' => 'Mailster\\Aws3\\Aws\\Exception\\MultipartUploadException'];
