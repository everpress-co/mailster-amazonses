 ...
 */
class Promise implements \Mailster\Aws3\GuzzleHttp\Promise\PromiseInterface
{
    ...
    public function then(callable $onFulfilled = null, callable $onRejected = null)
    {
        if ($this->state === self::PENDING) {
            $p = new \Mailster\Aws3\GuzzleHttp\Promise\Promise(null, [$this, 'cancel']);
    ...
    public function cancel()
    {
        ...
        if ($this->state === self::PENDING) {
            $this->reject(new \Mailster\Aws3\GuzzleHttp\Promise\CancellationException('Promise has been cancelled'));
        }
    }
