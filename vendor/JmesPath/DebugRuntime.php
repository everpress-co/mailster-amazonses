...
class DebugRuntime
{
    ...
    public function __construct(callable $runtime, $output = null)
    {
        ...
        $this->lexer = new \Mailster\Aws3\JmesPath\Lexer();
        $this->parser = new \Mailster\Aws3\JmesPath\Parser($this->lexer);
    }
    ...
    {
        $lexer = new \Mailster\Aws3\JmesPath\Lexer();
    ...
    {
        $parser = new \Mailster\Aws3\JmesPath\Parser();
