...
class AstRuntime
{
    ...
    public function __construct(\Mailster\Aws3\JmesPath\Parser $parser = null, callable $fnDispatcher = null)
    {
        $fnDispatcher = $fnDispatcher ?: \Mailster\Aws3\JmesPath\FnDispatcher::getInstance();
        $this->interpreter = new \Mailster\Aws3\JmesPath\TreeInterpreter($fnDispatcher);
        $this->parser = $parser ?: new \Mailster\Aws3\JmesPath\Parser();
    }
    /**
