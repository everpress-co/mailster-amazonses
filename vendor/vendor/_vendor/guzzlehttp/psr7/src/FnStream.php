 ...
 */
class FnStream implements \Mailster\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\Mailster\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
