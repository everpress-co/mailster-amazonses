 ...
 */
class MultipartStream implements \Mailster\Psr\Http\Message\StreamInterface
{
    ...
    {
        $stream = new \Mailster\GuzzleHttp\Psr7\AppendStream();
    ...
    private function addElement(\Mailster\GuzzleHttp\Psr7\AppendStream $stream, array $element)
    {
     ...
     * @return array
     */
    private function createElement($name, \Mailster\Psr\Http\Message\StreamInterface $stream, $filename, array $headers)
    {
