...
final class Utils
{
     ...
     * @internal
     */
    public static function idnUriConvert(\Mailster\Psr\Http\Message\UriInterface $uri, $options = 0)
    {
        if ($uri->getHost()) {
            ...
            if ($asciiHost === \false) {
                ...
                throw new \Mailster\GuzzleHttp\Exception\InvalidArgumentException($errorMessage);
            } else {
