...
class DebugRuntime
{
    ...
    public function __construct(callable $runtime, $output = null)
    {
        ...
        $this->lexer = new \Mailster\JmesPath\Lexer();
        $this->parser = new \Mailster\JmesPath\Parser($this->lexer);
    }
    public function __invoke($expression, $data)
    {
        if ($this->runtime instanceof \Mailster\JmesPath\CompilerRuntime) {
    ...
    {
        $lexer = new \Mailster\JmesPath\Lexer();
    ...
    {
        $parser = new \Mailster\JmesPath\Parser();
