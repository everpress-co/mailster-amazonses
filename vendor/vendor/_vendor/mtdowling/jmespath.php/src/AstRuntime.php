...
class AstRuntime
{
    ...
    public function __construct(\Mailster\JmesPath\Parser $parser = null, callable $fnDispatcher = null)
    {
        $fnDispatcher = $fnDispatcher ?: \Mailster\JmesPath\FnDispatcher::getInstance();
        $this->interpreter = new \Mailster\JmesPath\TreeInterpreter($fnDispatcher);
        $this->parser = $parser ?: new \Mailster\JmesPath\Parser();
    }
    /**
