 ...
 */
class S3ControlClient extends \Mailster\Aws\AwsClient
{
    ...
    public function __construct(array $args)
    {
        ...
        $stack->appendBuild(\Mailster\Aws\S3Control\S3ControlEndpointMiddleware::wrap($this->getRegion(), ['dual_stack' => $this->getConfig('use_dual_stack_endpoint')]), 's3control.endpoint_middleware');
    }
}
