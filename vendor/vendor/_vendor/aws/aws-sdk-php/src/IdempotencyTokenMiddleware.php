...
class IdempotencyTokenMiddleware
{
     ...
     * @return callable
     */
    public static function wrap(\Mailster\Aws\Api\Service $service, callable $bytesGenerator = null)
    {
        return function (callable $handler) use($service, $bytesGenerator) {
            return new self($handler, $service, $bytesGenerator);
        };
    }
    public function __construct(callable $nextHandler, \Mailster\Aws\Api\Service $service, callable $bytesGenerator = null)
    {
