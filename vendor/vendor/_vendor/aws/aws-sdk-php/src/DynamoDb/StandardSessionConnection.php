...
use Mailster\Aws\DynamoDb\Exception\DynamoDbException;
/**
 * The standard connection performs the read and write operations to DynamoDB.
 */
class StandardSessionConnection implements \Mailster\Aws\DynamoDb\SessionConnectionInterface
{
     ...
     */
    public function __construct(\Mailster\Aws\DynamoDb\DynamoDbClient $client, array $config = [])
    {
        $this->client = $client;
    ...
    public function read($id)
    {
        ...
        } catch (\Mailster\Aws\DynamoDb\Exception\DynamoDbException $e) {
    ...
    public function deleteExpired()
    {
        ...
        $batch = new \Mailster\Aws\DynamoDb\WriteRequestBatch($this->client, $this->getBatchConfig());
