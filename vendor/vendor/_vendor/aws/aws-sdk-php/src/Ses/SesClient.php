 ...
 */
class SesClient extends \Mailster\Aws\AwsClient
{
    /**
     ...
     * @return string
     */
    public static function generateSmtpPassword(\Mailster\Aws\Credentials\CredentialsInterface $creds)
    {
        static $version = "\2";
        static $algo = 'sha256';
