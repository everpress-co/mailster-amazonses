...
class EndpointProvider
{
    ...
    public static function resolve(callable $provider, array $args = [])
    {
        ...
        throw new \Mailster\Aws\Exception\UnresolvedEndpointException('Unable to resolve an endpoint using the provider arguments: ' . \json_encode($args) . '. Note: you can provide an "endpoint" ' . 'option to a client constructor to bypass invoking an endpoint ' . 'provider.');
    }
    /**
    ...
    {
        return \Mailster\Aws\Endpoint\PartitionEndpointProvider::defaultProvider();
    }
    /**
    ...
    {
        return new \Mailster\Aws\Endpoint\PatternEndpointProvider($patterns);
    }
}
