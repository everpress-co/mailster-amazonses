 ...
 */
class AesDecryptingStream implements \Mailster\Aws\Crypto\AesStreamInterface
{
    const BLOCK_SIZE = 16;
    // 128 bits
     ...
     */
    public function __construct(\Mailster\Psr\Http\Message\StreamInterface $cipherText, $key, \Mailster\Aws\Crypto\Cipher\CipherMethod $cipherMethod)
    {
