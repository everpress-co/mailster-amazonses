...
class JsonBody
{
     ...
     * @return string
     */
    public static function getContentType(\Mailster\Aws\Api\Service $service)
    {
    ...
    private function format(\Mailster\Aws\Api\Shape $shape, $value)
    {
        switch ($shape['type']) {
            case 'structure':
                $data = [];
            ...
            case 'timestamp':
                ...
                return \Mailster\Aws\Api\TimestampShape::format($value, $timestampFormat);
            default:
                return $value;
        }
    }
