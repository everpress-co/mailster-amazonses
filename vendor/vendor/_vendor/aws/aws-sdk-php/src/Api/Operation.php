 ...
 */
class Operation extends \Mailster\Aws\Api\AbstractModel
{
    private $input;
    private $output;
    private $errors;
    ...
    public function getInput()
    {
        if (!$this->input) {
            if ($input = $this['input']) {
                ...
                $this->input = new \Mailster\Aws\Api\StructureShape([], $this->shapeMap);
            }
        }
        return $this->input;
    }
    ...
    public function getOutput()
    {
        if (!$this->output) {
            if ($output = $this['output']) {
                ...
                $this->output = new \Mailster\Aws\Api\StructureShape([], $this->shapeMap);
            }
        }
        return $this->output;
    }
