...
use Mailster\Aws\Api\Parser\XmlParser;
 ...
 * Parses XML errors.
 */
class XmlErrorParser extends \Mailster\Aws\Api\ErrorParser\AbstractErrorParser
{
    use PayloadParserTrait;
    protected $parser;
    public function __construct(\Mailster\Aws\Api\Service $api = null, \Mailster\Aws\Api\Parser\XmlParser $parser = null)
    {
    ...
    private function parseHeaders(\Mailster\Psr\Http\Message\ResponseInterface $response, array &$data)
    {
