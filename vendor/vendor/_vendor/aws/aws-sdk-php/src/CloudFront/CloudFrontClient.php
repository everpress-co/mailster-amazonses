 ...
 */
class CloudFrontClient extends \Mailster\Aws\AwsClient
{
    /**
    ...
    public function getSignedUrl(array $options)
    {
        ...
        $urlSigner = new \Mailster\Aws\CloudFront\UrlSigner($options['key_pair_id'], $options['private_key']);
    ...
    public function getSignedCookie(array $options)
    {
        ...
        $cookieSigner = new \Mailster\Aws\CloudFront\CookieSigner($options['key_pair_id'], $options['private_key']);
