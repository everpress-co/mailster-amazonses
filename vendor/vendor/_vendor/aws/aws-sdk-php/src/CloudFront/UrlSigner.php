...
namespace Mailster\Aws\CloudFront;
...
class UrlSigner
{
    ...
    {
        $this->signer = new \Mailster\Aws\CloudFront\Signer($keyPairId, $privateKey);
    }
    /**
    ...
    public function getSignedUrl($url, $expires = null, $policy = null)
    {
        ...
        $uri = new \Mailster\GuzzleHttp\Psr7\Uri($scheme . '://' . $urlSections[1]);
        $query = \Mailster\GuzzleHttp\Psr7\parse_query($uri->getQuery(), \PHP_QUERY_RFC3986);
    ...
    private function createRtmpUrl(\Mailster\Psr\Http\Message\UriInterface $uri)
    {
