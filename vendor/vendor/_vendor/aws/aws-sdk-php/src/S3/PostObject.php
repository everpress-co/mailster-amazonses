...
class PostObject
{
     ...
     *                                      behalf.
     */
    public function __construct(\Mailster\Aws\S3\S3ClientInterface $client, $bucket, array $formInputs, $jsonPolicy)
    {
        $this->client = $client;
        $this->bucket = $bucket;
    ...
    protected function getPolicyAndSignature(\Mailster\Aws\Credentials\CredentialsInterface $creds)
    {
