 ...
 */
class InstructionFileMetadataStrategy implements \Mailster\Aws\Crypto\MetadataStrategyInterface
{
     ...
     *                            object keys.
     */
    public function __construct(\Mailster\Aws\S3\S3Client $client, $suffix = null)
    {
     ...
     */
    public function save(\Mailster\Aws\Crypto\MetadataEnvelope $envelope, array $args)
    {
    ...
    public function load(array $args)
    {
        ...
        $constantValues = \Mailster\Aws\Crypto\MetadataEnvelope::getConstantValues();
