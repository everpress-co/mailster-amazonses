...
use Mailster\Aws\CloudTrail\Exception\CloudTrailException;
/**
...
class LogFileIterator extends \IteratorIterator
{
    ...
    public static function forTrail(\Mailster\Aws\S3\S3Client $s3Client, \Mailster\Aws\CloudTrail\CloudTrailClient $cloudTrailClient, array $options = [])
    {
        ...
        } catch (\Mailster\Aws\CloudTrail\Exception\CloudTrailException $e) {
     ...
     * @param array    $options
     */
    public function __construct(\Mailster\Aws\S3\S3Client $s3Client, $s3BucketName, array $options = [])
    {
