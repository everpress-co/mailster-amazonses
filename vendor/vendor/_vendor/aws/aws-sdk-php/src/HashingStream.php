 ...
 */
class HashingStream implements \Mailster\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function __construct(\Mailster\Psr\Http\Message\StreamInterface $stream, \Mailster\Aws\HashInterface $hash, callable $onComplete = null)
    {
        $this->stream = $stream;
        $this->hash = $hash;
