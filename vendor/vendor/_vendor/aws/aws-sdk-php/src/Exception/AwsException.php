...
use Mailster\JmesPath\Env as JmesPath;
use Mailster\Psr\Http\Message\ResponseInterface;
use Mailster\Psr\Http\Message\RequestInterface;
/**
 * Represents an AWS exception that is thrown when a command fails.
 */
class AwsException extends \RuntimeException implements \Mailster\Aws\MonitoringEventsInterface, \Mailster\Aws\ResponseContainerInterface, \ArrayAccess
{
    use HasDataTrait;
     ...
     */
    public function __construct($message, \Mailster\Aws\CommandInterface $command, array $context = [], \Exception $previous = null)
    {
    ...
    {
        return \Mailster\JmesPath\Env::search($expression, $this->toArray());
    }
}
