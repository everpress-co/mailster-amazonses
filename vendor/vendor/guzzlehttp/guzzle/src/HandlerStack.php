...
class HandlerStack
{
    ...
    public static function create(callable $handler = null)
    {
        ...
        $stack->push(\Mailster\GuzzleHttp\Middleware::httpErrors(), 'http_errors');
        $stack->push(\Mailster\GuzzleHttp\Middleware::redirect(), 'allow_redirects');
        $stack->push(\Mailster\GuzzleHttp\Middleware::cookies(), 'cookies');
        $stack->push(\Mailster\GuzzleHttp\Middleware::prepareBody(), 'prepare_body');
        return $stack;
    }
    /**
