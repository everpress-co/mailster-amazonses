...
class StreamWrapper
{
     ...
     */
    public static function getResource(\Mailster\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\Mailster\Psr\Http\Message\StreamInterface $stream)
    {
