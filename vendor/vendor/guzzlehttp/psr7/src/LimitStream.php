 ...
 */
class LimitStream implements \Mailster\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function __construct(\Mailster\Psr\Http\Message\StreamInterface $stream, $limit = -1, $offset = 0)
    {
        $this->stream = $stream;
        $this->setLimit($limit);
