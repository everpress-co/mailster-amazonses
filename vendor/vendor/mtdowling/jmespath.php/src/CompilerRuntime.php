...
class CompilerRuntime
{
     ...
     */
    public function __construct($dir = null, \Mailster\JmesPath\Parser $parser = null)
    {
        $this->parser = $parser ?: new \Mailster\JmesPath\Parser();
        $this->compiler = new \Mailster\JmesPath\TreeCompiler();
        ...
        $this->interpreter = new \Mailster\JmesPath\TreeInterpreter();
    }
    /**
