...
class SessionHandler implements \SessionHandlerInterface
{
     ...
     */
    public static function fromClient(\Mailster\Aws\DynamoDb\DynamoDbClient $client, array $config = [])
    {
        $config += ['locking' => \false];
        if ($config['locking']) {
            $connection = new \Mailster\Aws\DynamoDb\LockingSessionConnection($client, $config);
        } else {
            $connection = new \Mailster\Aws\DynamoDb\StandardSessionConnection($client, $config);
        }
     ...
     */
    public function __construct(\Mailster\Aws\DynamoDb\SessionConnectionInterface $connection)
    {
