...
namespace Mailster\Aws\DynamoDbStreams;
 ...
 */
class DynamoDbStreamsClient extends \Mailster\Aws\AwsClient
{
    public static function getArguments()
    {
        $args = parent::getArguments();
        $args['retries']['default'] = 11;
        $args['retries']['fn'] = [\Mailster\Aws\DynamoDb\DynamoDbClient::class, '_applyRetryConfig'];
        return $args;
    }
}
