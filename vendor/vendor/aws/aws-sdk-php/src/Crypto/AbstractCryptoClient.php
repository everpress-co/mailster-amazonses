...
use Mailster\Aws\Crypto\Cipher\CipherMethod;
use Mailster\Aws\Crypto\Cipher\Cbc;
...
abstract class AbstractCryptoClient
{
     ...
     * @internal
     */
    public abstract function encrypt(\Mailster\GuzzleHttp\Psr7\Stream $plaintext, array $cipherOptions, \Mailster\Aws\Crypto\MaterialsProvider $provider, \Mailster\Aws\Crypto\MetadataEnvelope $envelope);
    /**
     ...
     * @internal
     */
    public abstract function decrypt($cipherText, \Mailster\Aws\Crypto\MaterialsProvider $provider, \Mailster\Aws\Crypto\MetadataEnvelope $envelope, array $cipherOptions = []);
}
