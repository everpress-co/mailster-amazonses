 ...
 */
class Ec2Client extends \Mailster\Aws\AwsClient
{
    public function __construct(array $args)
    {
        $args['with_resolved'] = function (array $args) {
            $this->getHandlerList()->appendInit(\Mailster\Aws\PresignUrlMiddleware::wrap($this, $args['endpoint_provider'], ['operations' => ['CopySnapshot'], 'service' => 'ec2', 'presign_param' => 'PresignedUrl']), 'ec2.copy_snapshot');
        };
