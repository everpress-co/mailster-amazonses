 ...
 */
class LambdaClient extends \Mailster\Aws\AwsClient
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return \Mailster\Aws\Middleware::mapCommand(function (\Mailster\Aws\CommandInterface $cmd) {
