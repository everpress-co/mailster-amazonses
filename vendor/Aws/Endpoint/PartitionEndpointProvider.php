...
use Mailster\Aws3\JmesPath\Env;
class PartitionEndpointProvider
{
    ...
    {
        $data = \Mailster\Aws3\Aws\load_compiled_json(__DIR__ . '/../data/endpoints.json');
        $prefixData = \Mailster\Aws3\Aws\load_compiled_json(__DIR__ . '/../data/endpoints_prefix_history.json');
