...
namespace Mailster\Aws3\Aws\Endpoint\UseDualstackEndpoint;

use Mailster\Aws3\Aws\AbstractConfigurationProvider;
use Mailster\Aws3\Aws\CacheInterface;
use Mailster\Aws3\Aws\ConfigurationProviderInterface;
use Mailster\Aws3\Aws\Endpoint\UseDualstackEndpoint\Exception\ConfigurationException;
...
class ConfigurationProvider extends AbstractConfigurationProvider implements ConfigurationProviderInterface
{
    ...
    public static function ini($region, $profile = null, $filename = null)
    {
        ...
        return function () use($region, $profile, $filename) {
            ...
            $data = \Mailster\Aws3\Aws\parse_ini_file($filename, \true, \INI_SCANNER_NORMAL);
            if ($data === \false) {
