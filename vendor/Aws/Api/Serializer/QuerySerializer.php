...
class QuerySerializer
{
    ...
    public function __construct(\Mailster\Aws3\Aws\Api\Service $api, $endpoint, callable $paramBuilder = null)
    {
        $this->api = $api;
        $this->endpoint = $endpoint;
        $this->paramBuilder = $paramBuilder ?: new \Mailster\Aws3\Aws\Api\Serializer\QueryParamBuilder();
    }
    /**
    ...
    public function __invoke(\Mailster\Aws3\Aws\CommandInterface $command)
    {
        ...
        return new \Mailster\Aws3\GuzzleHttp\Psr7\Request('POST', $this->endpoint, ['Content-Length' => strlen($body), 'Content-Type' => 'application/x-www-form-urlencoded'], $body);
    }
}
