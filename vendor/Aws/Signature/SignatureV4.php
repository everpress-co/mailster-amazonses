...
use Mailster\Aws3\AWS\CRT\Auth\Signable;
use Mailster\Aws3\AWS\CRT\Auth\SignatureType;
use Mailster\Aws3\AWS\CRT\Auth\Signing;
use Mailster\Aws3\AWS\CRT\Auth\SigningAlgorithm;
use Mailster\Aws3\AWS\CRT\Auth\SigningConfigAWS;
use Mailster\Aws3\AWS\CRT\Auth\StaticCredentialsProvider;
use Mailster\Aws3\AWS\CRT\HTTP\Request;
use Mailster\Aws3\Aws\Exception\CommonRuntimeException;
...
class SignatureV4 implements SignatureInterface
{
    ...
    protected function signWithV4a(CredentialsInterface $credentials, RequestInterface $request, $signingService)
    {
        ...
        $illegalV4aHeaders = [self::AMZ_CONTENT_SHA256_HEADER, "aws-sdk-invocation-id", "aws-sdk-retry"];
