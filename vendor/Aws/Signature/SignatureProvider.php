...
use Mailster\Aws3\Aws\Token\BearerTokenAuthorization;
/**
 * Signature providers.
 *
    ...
    public static function version()
    {
        return function ($version, $service, $region) {
            switch ($version) {
                ...
                case 'v4a':
                    return !empty(self::$s3v4SignedServices[$service]) ? new S3SignatureV4($service, $region) : new SignatureV4($service, $region, ['use_v4a' => \true]);
