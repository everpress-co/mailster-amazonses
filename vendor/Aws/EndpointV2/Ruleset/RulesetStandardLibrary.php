...
namespace Mailster\Aws3\Aws\EndpointV2\Ruleset;
...
class RulesetStandardLibrary
{
    ...
    public function callFunction($funcCondition, &$inputParameters)
    {
        ...
        $result = \call_user_func_array(['Mailster\\Aws3\\Aws\\EndpointV2\\Ruleset\\RulesetStandardLibrary', $funcName], $funcArgs);
