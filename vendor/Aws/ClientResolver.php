...
use Mailster\Aws3\Aws\Configuration\ConfigurationResolver;
...
class ClientResolver
{
    ...
    public static function _apply_user_agent($inputUserAgent, array &$args, HandlerList $list)
    {
        ...
        if (isset($args['endpoint_discovery'])) {
            if ($args['endpoint_discovery'] instanceof \Mailster\Aws3\Aws\EndpointDiscovery\Configuration && $args['endpoint_discovery']->isEnabled()) {
        ...
        if (isset($args['retries'])) {
            if ($args['retries'] instanceof \Mailster\Aws3\Aws\Retry\Configuration) {
