...
use Mailster\Aws3\Aws\Endpoint\PartitionInterface;
class MultiRegionClient implements \Mailster\Aws3\Aws\AwsClientInterface
{
    use AwsClientTrait;
    ...
    {
        $args = array_intersect_key(\Mailster\Aws3\Aws\ClientResolver::getDefaultArguments(), ['service' => true, 'region' => true]);
        ...
        return $args + ['client_factory' => ['type' => 'config', 'valid' => ['callable'], 'doc' => 'A callable that takes an array of client' . ' configuration arguments and returns a regionalized' . ' client.', 'required' => true, 'internal' => true, 'default' => function (array $args) {
            ...
            $klass = "Mailster\\Aws3\\Aws\\{$namespace}\\{$namespace}Client";
        ...
        }], 'partition' => ['type' => 'config', 'valid' => ['string', \Mailster\Aws3\Aws\Endpoint\PartitionInterface::class], 'doc' => 'AWS partition to connect to. Valid partitions' . ' include "aws," "aws-cn," and "aws-us-gov." Used to' . ' restrict the scope of the mapRegions method.', 'default' => function (array $args) {
            $region = isset($args['region']) ? $args['region'] : '';
            return \Mailster\Aws3\Aws\Endpoint\PartitionEndpointProvider::defaultProvider()->getPartition($region, $args['service']);
        }, 'fn' => function ($value, array &$args) {
            if (is_string($value)) {
                $value = \Mailster\Aws3\Aws\Endpoint\PartitionEndpointProvider::defaultProvider()->getPartitionByName($value);
            }
    ...
    public function __construct(array $args = [])
    {
        ...
        $this->handlerList = new \Mailster\Aws3\Aws\HandlerList(function (\Mailster\Aws3\Aws\CommandInterface $command) {
        ...
        $resolver = new \Mailster\Aws3\Aws\ClientResolver($argDefinitions);
